...
void rikiavimasEilutemNuoMaziausioIkiDidziausio(int Arr[][col], int row, int col);
...
int main()
{
   ...
   generavimas(A, n, m);
   rasymas(A, n, m);
    rikiavimasEilutemNuoMaziausioIkiDidziausio(A, n, m);
    out<<"\n surikiuotas eilutem nuo maziausio iki didziausio \n";
    rasymas(A, n, m);
    out.close();
    return 0;
}
